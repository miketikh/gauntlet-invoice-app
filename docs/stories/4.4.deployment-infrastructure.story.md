...
## Tasks / Subtasks
- [ ] Create backend Dockerfile (AC: 1)
...
- [ ] Create frontend Dockerfile (AC: 2)
...
- [ ] Create nginx configuration (AC: 2)
  - [ ] Create nginx.conf
...
- [ ] Create Docker Compose for local development (AC: 3)
...
- [ ] Create environment-specific configuration (AC: 4)
...
- [ ] Add health check endpoints (AC: 5)
...
- [ ] Configure database migrations with Flyway (AC: 6)
...
- [ ] Create environment variable template (AC: 4)
...
- [ ] Create CI/CD pipeline with GitHub Actions (AC: 7)
...
- [ ] Add Docker build scripts (AC: 1, 2, 3)
...
- [ ] Create deployment documentation (AC: 8)
...
- [ ] Add AWS deployment instructions (AC: 8)
...
- [ ] Add Azure deployment instructions (AC: 8)
...
- [ ] Create production configuration checklist (AC: 4, 8)
  - [ ] Security checklist:
...
- [ ] Test local Docker deployment (AC: 3)
...
- [ ] Add container optimization (AC: 1, 2)
...
- [ ] Add security to Docker images (AC: 1, 2)
