...
## Tasks / Subtasks
- [ ] Create invoice form component and route (AC: 1, 4, 6, 8)
...
- [ ] Implement line items manager component (AC: 2, 3)
...
- [ ] Implement real-time invoice total calculations (AC: 3)
...
- [ ] Implement form submission and API integration (AC: 6, 7)
...
- [ ] Implement auto-save draft functionality (AC: 5)
...
- [ ] Implement edit invoice functionality (AC: 1-8)
...
- [ ] Add form validation matching backend rules (AC: 6)
...
- [ ] Create invoice state management (AC: 1-8)
...
- [ ] Add Zod schema and TypeScript types (AC: 6)
...
- [ ] Implement UI/UX enhancements (AC: 8)
